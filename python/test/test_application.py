...
def test_invalid_mode(base_dir):
...
def test_dry_run_keeps_original_files(base_dir):
    Application().run()
...
def test_execution_mode_restructures_files(base_dir):
...
def test_execution_mode_with_custom_delimiter(base_dir):
